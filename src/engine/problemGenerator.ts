هذا هو محرك اختيار الأسئلة.
وهو الذي يسمح لاحقاً بأن نقول:
أعطني 10 أسئلة من L03.S01
أعطني 5 أسئلة عن قاعدة 10+
أعطني سؤالاً أصعب
أعطني سؤالاً علاجياً
أعطني أسئلة لم ينجح فيها الطفل
import type {
  Problem,
